...
const { verificarLogin, verificarLoginPartido } = require('./intermediarios/autenticacao')
...
const { cadastrarPartido, loginPartido, listarPartido, excluirPartido, atualizarPartido } = require('./controladores/partidos')
